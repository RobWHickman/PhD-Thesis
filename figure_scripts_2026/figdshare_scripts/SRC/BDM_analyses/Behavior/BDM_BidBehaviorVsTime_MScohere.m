...
cx1=mscohere(mbWtr_filled(:,1),mbWtr_filled(:,2),3,1);
cx2=mscohere(mbWtr_filled(:,2),mbWtr_filled(:,3),3,1);
cx3=mscohere(mbWtr_filled(:,1),mbWtr_filled(:,3),3,1);

% figure
% plot(mbWtr_filled)
% 
% figure;cpsd(mbWtr_filled(:,1),mbWtr_filled(:,2))
% figure;cpsd(mbWtr_filled(:,2),mbWtr_filled(:,3))
% figure;cpsd(mbWtr_filled(:,1),mbWtr_filled(:,3))
% Tile_figs
% ca
r(1,2)=cx1(1);
r(1,3)=cx2(1);
