function [LMH]=GettyBidTracesWithClustersRobust(data_file_path_name,situations,bits,trials,win_lose_both)
...
st= ismember([DS.situation],situations);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
goodix = noErix & noFR & wl & st;%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%             [srp,srh]= signrank(low,high);
            ...
            [r,p] = corr(mb',fr);% % % % % % % % % % % % % % % % % % % % % % %
            %%
            if  p<corrp && r >0 || pb<corrp && rb >0 ||  pop %srp<corrp || % % % % % % % % % % % % % % % % % % % % % % % %
