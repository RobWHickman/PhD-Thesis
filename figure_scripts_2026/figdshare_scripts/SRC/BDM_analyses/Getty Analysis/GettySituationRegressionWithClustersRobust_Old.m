...
%             strz = smoothdata(trz,2,'gaussian',10);
            ...
            if sw
                ...
                %
                for i= 1:cls%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                    [rp(2,i),rp(1,i)] = corr(sit',nbtrz(:,i));%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            if ~sw && p<corrp && r >0 ||  pop  || ...
                    sw && ~isempty(sigg) && all(rp(2,sigg)>0) || pop %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                %                 disp(sigg*nbin)
...
%                     cont = (sum(ctrz(:,(pre-cont_comp)/bin),2)/cont_comp)*1000;
                    out = mean(trz(:,compix),2);
                    cont = mean(ctrz(:,(pre-cont_comp)/bin),2);
                end     
