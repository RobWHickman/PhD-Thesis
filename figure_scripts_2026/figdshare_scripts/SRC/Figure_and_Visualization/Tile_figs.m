...
scrnsize(2) = scrnsize(4)/22;
scrnsize(4) = scrnsize(4)-scrnsize(4)/22;
...
%     iCls = 1:cls;
    ...
    pos = [scrnsize(1,1)+(vscrnchunk*(iCls-1)) scrnsize(1,2)+(hscrnchunk*(iRws-1))...
        scrnsize(1,3)/cls (scrnsize(1,4)/rws)-82.8];
